                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="grid grid-cols-4 gap-4 text-sm">
                        <div className="font-medium">{journalEntry.debitAccount}</div>
                        <div className="text-right font-variant-numeric: tabular-nums">${journalEntry.amount.toFixed(2)}</div>
                        <div className="text-right">—</div>
                        <div className="text-right">{confidence}%</div>
                      </div>
                      <div className="grid grid-cols-4 gap-4 text-sm">
                        <div className="font-medium">{journalEntry.creditAccount}</div>
                        <div className="text-right">—</div>
                        <div className="text-right font-variant-numeric: tabular-nums">${journalEntry.amount.toFixed(2)}</div>
                        <div className="text-right">{confidence}%</div>
                      </div>
